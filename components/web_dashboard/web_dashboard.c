...
static const char DASHBOARD_HTML[] =
    ...
    "body{font-family:'VT323',monospace;background:#0B0C10;color:#39FF14;min-height:100vh;display:flex;flex-direction:column}"
    ".hdr{background:#0B0C10;border-bottom:3px solid #39FF14;padding:2px 8px;display:flex;align-items:center;gap:4px;height:40px;flex-shrink:0}"
    ".hdr .t{font-size:13px;color:#39FF14;letter-spacing:2px;text-transform:uppercase;white-space:nowrap}"
    ".hdr .m{font-size:13px;color:#39FF14;letter-spacing:2px;margin-left:auto}"
    ".hdr .s{font-size:10px;color:#555;white-space:nowrap}"
    ".lo{display:flex;flex:1;min-height:0}"
    ".nav{width:56px;background:#0B0C10;border-right:2px solid #1A1C2A;display:flex;flex-direction:column;align-items:center;padding:4px 0;overflow-y:auto;flex-shrink:0}"
    ".nav a{display:flex;flex-direction:column;align-items:center;justify-content:center;width:48px;min-height:44px;color:#555;text-decoration:none;font-size:8px;border:1px solid transparent;cursor:pointer}"
    ".nav a:active,.nav a.active{color:#39FF14;border-color:#39FF14;background:rgba(57,255,20,.05)}"
    ...
    ".card{background:#111216;border:2px solid #1A1C2A;padding:6px;width:100%}"
    ".card h3{font-size:10px;color:#555;text-transform:uppercase;letter-spacing:1px;margin-bottom:4px}"
    ".card .value{font-size:18px;color:#39FF14}"
    ".card .value.green{color:#39FF14}"
    ".card .value.red{color:#FF003C}"
    ".card .value.blue{color:#4488ff}"
    ".card .value.yellow{color:#ffaa00}"
    "table{width:100%;border-collapse:collapse;font-size:11px}"
    "th,td{padding:4px 8px;text-align:left;border:1px solid #1A1C2A}"
    "th{color:#555;font-size:9px;text-transform:uppercase;letter-spacing:1px;background:#0B0C10}"
    "td{color:#39FF14;font-family:'VT323',monospace;font-size:11px}"
    "tr:hover{background:rgba(57,255,20,.03)}"
    ".badge{display:inline-block;padding:1px 6px;font-size:9px;text-transform:uppercase;border:1px solid currentColor}"
    ".badge.open{border-color:#39FF14;color:#39FF14}"
    ".badge.wpa2{border-color:#ffaa00;color:#ffaa00}"
    ".badge.wpa3{border-color:#aa88ff;color:#aa88ff}"
    ".btn{display:inline-block;min-height:44px;padding:8px 16px;border:2px solid #1A1C2A;background:#0B0C10;color:#39FF14;font-family:'VT323',monospace;font-size:14px;cursor:pointer;margin:2px}"
    ".btn:active{background:rgba(57,255,20,.1);border-color:#39FF14}"
    ".btn-primary{border-color:#39FF14;color:#39FF14}"
    ...
    ".form-group label{display:block;font-size:11px;color:#555;margin-bottom:2px;text-transform:uppercase;letter-spacing:1px}"
    ".form-group input,.form-group select{width:100%;min-height:44px;padding:8px;background:#0B0C10;border:2px solid #1A1C2A;color:#39FF14;font-family:'VT323',monospace;font-size:14px}"
    ".form-group input:focus,.form-group select:focus{outline:none;border-color:#39FF14}"
    ".log-viewer{background:#050810;border:2px solid #1A1C2A;padding:8px;font-family:'VT323',monospace;font-size:11px;height:180px;overflow-y:auto;white-space:pre-wrap;line-height:1.5}"
    ".log-viewer .info{color:#555}"
    ".log-viewer .warn{color:#ffaa00}"
    ".log-viewer .error{color:#FF003C}"
    ".log-viewer .cred{color:#39FF14}"
    ".empty{text-align:center;padding:20px;color:#333;font-size:12px}"
    ".capture-entry{background:#111216;border:2px solid #1A1C2A;padding:8px;margin-bottom:4px;font-size:11px}"
    ".capture-entry .src{color:#4488ff}"
    ".capture-entry .ts{color:#555;float:right}"
    ".capture-entry .user{color:#39FF14}"
    ".capture-entry .pass{color:#FF003C}"
    ...
    ".modal-content{background:#111216;border:2px solid #39FF14;padding:16px;max-width:480px;width:90%;max-height:80vh;overflow-y:auto}"
    ".modal-content h2{color:#39FF14;margin-bottom:12px}"
    ".step-badge{display:inline-block;padding:4px 10px;font-size:10px;background:#111216;color:#555;border:2px solid #1A1C2A}"
    ".step-badge.active{color:#ffaa00;border-color:#ffaa00}"
    ".step-badge.done{color:#39FF14;border-color:#39FF14}"
    ".step-badge.cracked{color:#FF003C;border-color:#FF003C}"
    "@keyframes stepPulse{0%,100%{opacity:1}50%{opacity:.6}}"
    ".bar{display:none;position:fixed;bottom:0;left:0;width:100%;height:52px;background:#0B0C10;border-top:2px solid #1A1C2A;z-index:100}"
    ".bar a{flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;color:#555;text-decoration:none;font-size:8px;min-height:44px;border:none;background:none;cursor:pointer}"
    ".bar a:active,.bar a.active{color:#39FF14}"
    ".bar a .i{font-size:16px;line-height:1.2}"
    ".mo{display:none;position:fixed;bottom:52px;left:0;width:100%;max-height:50vh;background:#111216;border:2px solid #1A1C2A;border-bottom:none;z-index:99;overflow-y:auto}"
    ".mo.active{display:block}"
    ".mo a{display:flex;align-items:center;gap:8px;padding:10px 16px;color:#555;text-decoration:none;border-bottom:1px solid #1A1C2A;font-size:13px;min-height:44px}"
    ".mo a:active{color:#39FF14;background:rgba(57,255,20,.03)}"
